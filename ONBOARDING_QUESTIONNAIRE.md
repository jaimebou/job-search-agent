...
1. Comprueba si ya existe `JOB_SEARCH_CRITERIA.md` en la raíz. Si existe, pregunta primero si quiere **rehacerlo desde cero** o **revisar/editar secciones concretas** — no lo sobrescribas sin confirmación.
